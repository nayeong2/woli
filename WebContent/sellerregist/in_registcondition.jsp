			...
			<label><h3>판매자 등록 상황</h3></label>
				...
				<h6>기본정보</h6>
					<table class="table" style="font-size: 12px" >
					    ...
					    <tr valign="middle">
					      <td valign="middle" class="table-active" width="20%">
					      	<label><font color="red">*</font>성명</label>
					      </td>
					      <td>
					      	<label id="" name="">홍길동</label>
					      </td>
					      <td valign="middle" class="table-active" width="20%">
					      	<label><font color="red">*</font>주민번호</label>
					      </td>
					      <td>
					      	<label id="" name="">900101-1212121</label>
					      </td>
						</tr>
						<tr valign="middle">
					      <td valign="middle" class="table-active" width="20%">
					      	<label><font color="red">*</font>닉네임</label>
					      </td>
					      <td colspan="3">
					      	<label id="" name="">육아킹</label>
					      </td>
						</tr>

						<!-- 프로필, 소개 사진 삭제 여부확인 -->
						<tr>
							<td class="table-active"><label><font color="red">*</font>프로필사진</label></td>
							  <td>
							  	<div>
							    ...
							    <td class="table-active"><label><font color="red">*</font>소개이미지</label></td>
								  <td>
								  	<div>
						...
						<tr valign="middle">
					      <td class="table-active"><label><font color="red">*</font>전화번호:</label></td>
						  <td>
						  	<label id="" name="">02-3829-3828</label>
						  </td>
						</tr>
						<tr valign="middle">
					      <td class="table-active"><label><font color="red">*</font>팩스:</label></td>
						  <td colspan="3">
						  	<label id="" name="">02-1211-1111</label>
						  </td>
						</tr>
						...
						<tr valign="middle">
					      <td class="table-active">
						 	...
						 	<td colspan="3">
								<label id="" name="">example</label>
										@
								<label id="" name="">google.com</label>
															  	</td>
							</tr>
					    <tr valign="middle" >
					      <td class="table-active" valign="middle"><label><font color="red">*</font>주소:</label></td>
						  <td colspan="3">
						  	<label id="" name="">31231</label><br>
						  	<label id="" name="">경기도 남양주시 오남읍 오남리</label>
						  	<label id="" name="">392-20 번지 701호</label>
						  </td>
						</tr>
					    ...
					    <tr valign="middle">
						  ...
						  <td colspan="3">
						  	<label id="" name="">국민은행</label><br>
						  	<label id="" name="">3822999291929</label>
						  </td>
						</tr>
					    <tr valign="middle">
						...
						<tr valign="middle">
					      ...
					      <td>
						 	<label id="" name="">자격증 1</label><br>
						 	<label id="" name="">자격증 2</label><br>
						 	<label id="" name="">자격증 3</label><br>
						  	</td>
						</tr>
