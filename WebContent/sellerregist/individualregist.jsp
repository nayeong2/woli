			...
			<h3>판매자 등록(개인)</h3>
				<h6>기본정보</h6>
					<table class="table" style="font-size: 12px" >
						...
						<tr valign="middle">
						  <td class="table-active" width="20%"><label><font color="red">*</font>아이디</label></td>
						  <td width="30%">
						  	<label>회원아이디 위치</label>
						  </td>
						  	<td class="table-active"><label><font color="red">*</font>비밀번호</label></td>
						  	<td>
					...
					<table class="table" style="font-size: 12px" >
					    <tr valign="middle">
					      ...
					      <td>
					      	<div class="row">
					      		<div class="col-5">
					      			<input type="text" class="form-control" id="socialnum1" name="socialnum1">
					      		</div>
					      		<div class="col-0.5" align="center" style="margin-top: 8px; float: left" >
					      			-
					      		</div>
						...
						<tr valign="middle">
					      <td valign="middle" class="table-active" width="20%">
					      	<label><font color="red">*</font>대화명</label>
					      </td>
					      <td>
					      	<input type="text" class="form-control" id="name" name="name">
					      </td>
					      <td colspan="2">
					      	<label style="margin-top: 8px"><font color="red" >대화명을 입력하세요</font></label>
					      </td>
						</tr>
					    ...
					    <tr valign="middle" >
					      <td class="table-active" valign="middle" rowspan="3"><label><font color="red">*</font>주소:</label></td>
						  <td colspan="3">
						  <div class="input-group mb-3">
